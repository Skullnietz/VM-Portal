...
class MissingItemsSummarySheet implements FromCollection, WithHeadings, WithTitle, WithEvents, ShouldAutoSize
{
    protected $idMaquina;
    ...
    {
        // Obtener resumen de faltantes agrupado por artículo y talla
        $resumen = DB::table('Configuracion_Maquina')
            ...
            ->select(
                ...
                DB::raw('SUM(Configuracion_Maquina.Cantidad_Max - Configuracion_Maquina.Stock) as Total_Faltante')
            )
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Resumen de Faltantes - ' . $this->nombreMaquina);
