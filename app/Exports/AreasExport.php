...
class AreasExport implements FromCollection, WithHeadings, WithEvents, ShouldAutoSize
{
    public function collection()
    {
        ...
        foreach ($areas as $area) {
            // Contar el número de empleados afiliados a esta área
            $area->Num_Empleados = DB::table('Cat_Empleados')
                ->where('Id_Area', $area->Id_Area)
                ->where('Id_Planta', $_SESSION['usuario']->Id_Planta)
                ->count();

            // Contar el número de permisos afiliados a esta área
        ...
        // Mapeo para organizar las columnas según lo solicitado
