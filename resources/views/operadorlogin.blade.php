...
<body class="login-page">
    ...
    <div class="login-box">
        <div class="login-logo">
            <a href="">
                <img src="http://127.0.0.1:8000/vendor/adminlte/dist/img/vending-machine2.png" alt="Admin Logo" height="50">
                <b>OPERADOR</b> VM
            </a>
        </div>
        <div class="card card-outline card-success" style="border-radius:15px">
            <div class="card-header ">
                <h3 class="card-title float-none text-center">
                    <b>Portal de Operadores VM</b>
                </h3>
            </div>
            <div class="card-body login-card-body " style="border-radius:15px">
                <form method="POST" action="op/validar-operador">
                    @csrf
                    <div class="input-group mb-3">
                        <input type="text" name="usuario" class="form-control " value="{{ old('usuario') }}" placeholder="Usuario" autofocus>
