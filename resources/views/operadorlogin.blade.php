...
<style>
    ...
    body {
        ...
        background-image: url('/Images/Backgrounds/bgop.png') !important;
...
@php( $login_url = route('login.operador', ['language' => app()->getLocale() ?: 'es']) )
...
<div class="glass-card">
    <h4 class="custom-welcome-msg">Portal de Operadores</h4>
    ...
    <form action="{{ $login_url }}" method="post">
        ...
        <div class="custom-input-wrapper">
            <input type="text" name="usuario" class="form-control" value="{{ old('usuario') }}" placeholder="Usuario"
                autofocus>
            <span class="fas fa-user-cog custom-icon"></span>
        </div>
        <div class="custom-input-wrapper">
