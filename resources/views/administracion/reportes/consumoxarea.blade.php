...
@section('title', __('Reporte Consumo por Area - Admin'))
        ...
        <div class="col text-left">
            <h4>
                <a href="#" onclick="goBack()" class="border rounded">&nbsp;<i
                        class="fas fa-arrow-left"></i>&nbsp;</a>&nbsp;&nbsp;&nbsp;{{ __('Reporte de Consumo por Area (Admin)') }}
            </h4>
        </div>
        <div class="col text-right">
            <form id="export-form" action="{{ route('admin.export.consumoxarea') }}" method="GET">
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#consumptionReport').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route("admin.getconsumoxarea.data") }}',
                data: function (d) {
