            ...
            <div class="modal-body">
                <form id="addAreaForm">
                    <div class="form-group">
                        ...
                        <input type="hidden" value="{{$planta->Id_Planta}}" class="form-control" id="idPlanta"
                            name="idPlanta" required>
                    </div>
                ...
                <form id="editForm">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text input-group-text-fixed"><i
                                        class="fas fa-key"></i>&nbsp;&nbsp;| NIP</span>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text input-group-text-fixed"><i
                                        class="fas fa-address-card"></i>&nbsp;&nbsp;| ID Tarjeta</span>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text input-group-text-fixed"><i
                                        class="fas fa-user"></i>&nbsp;&nbsp;| Nombre</span>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text input-group-text-fixed"><i
                                        class="fas fa-user"></i>&nbsp;&nbsp;| Apellido Paterno</span>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text input-group-text-fixed"><i
                                        class="fas fa-user"></i>&nbsp;&nbsp;| Apellido Materno</span>
                            </div>
                            <input type="text" class="form-control" id="amaterno" name="amaterno">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="area"><i class="fas fa-warehouse"></i>&nbsp;&nbsp;&nbsp;Área &nbsp;|
                            &nbsp;&nbsp;Permisos de Producto</label>
...
<div class="modal fade" id="uploadCsvModal" tabindex="-1" role="dialog" aria-labelledby="uploadCsvModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('/planta/import-csv-employees?idPlanta=') }}{{$planta->Id_Planta}}" method="POST"
                ...
                <form id="addEmployeeForm">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text input-group-text-fixed"><i
                                        class="fas fa-id-card-alt"></i>&nbsp;&nbsp;| N° Empleado</span>
                            </div>
            ...
            <div class="col-md-3">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="{{$planta->Ruta_Imagen}}"
                            ...
                            @foreach($vendings as $vending)
                                ...
                                <p class="text-{{ $vending->Txt_Estatus === 'Alta' ? 'success' : 'danger' }}">
                                    <span class="dot-status"
                                        style="display: inline-block; width: 10px; height: 10px; border-radius: 50%; background-color: {{ $vending->Txt_Estatus === 'Alta' ? '#28a745' : '#dc3545' }}; margin-right: 5px;"></span>
                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active" id="linkarea" href="#areas"
                                    data-toggle="tab">Áreas</a></li>
                            <li class="nav-item"><a class="nav-link" id="linkpermiso" href="#permisos"
                                    data-toggle="tab">Permisos por Área</a></li>
                            <li class="nav-item"><a class="nav-link" id="linkempleado" href="#empleados"
                        ...
                        <div class="tab-content">
                                ...
                                <div class="col text-right">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                            ...
                                            Agregar Área &nbsp;&nbsp;&nbsp;&nbsp;<i
                                                class="fas fa-plus-circle fa-xs"></i> <i class="fas fa-square"></i>
                                        </button>
                                        <button type="button" class="btn btn-warning" id="generar-permisos">
                                            Actualizar Permisos &nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-lock "></i> <i
                                                class="fas fa-sync-alt fa-xs"></i>
                                        </button>
                                        <a href="{{ url('/planta/export-excel-areas?idPlanta=') }}{{$planta->Id_Planta}}"
                            ...
                            <div class="tab-pane" id="empleados">
                                ...
                                <div class="col text-right">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a type="button"
                                            href="{{ url('/planta/export-csv-employees?idPlanta=') }}{{$planta->Id_Planta}}"
                                            class="btn btn-secondary">
                                            Descarga .CSV &nbsp;&nbsp;&nbsp;<i class="fas fa-file-csv"></i> <i
                                        ...
                                        <a href="{{ url('/planta/export-excel-employees?idPlanta=') }}{{$planta->Id_Planta}}"
                                            type="button" class="btn btn-success">
                                            Reporte &nbsp;&nbsp;&nbsp;<i class="fas fa-file-excel"></i>
                                        </a>
                                    </div><br><br>
...
<script>
    ...
    $(document).ready(function () {
            ...
            columns: [
                { data: 'Id_Area' },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        input.className = 'form-control editable-name';
                        input.setAttribute('data-id', row.Id_Area);
                        input.value = data;
                        input.disabled = true;
        ...
        $('#areas,#empleados').on('click', '.btn-info', function (e) {
            ...
            // Obtener Id_Planta desde la variable de Blade
            var idPlanta = {{ $planta->Id_Planta }};

            console.log("ID de Planta:", idPlanta);
            console.log("ID de Área:", idArea);

            if (!idArea) {
                console.error("ID de Área no encontrado");
                return;
            }
            ...
            $('#permisos-articulos-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('/admin/plantas/PlantaView') }}/" + idPlanta + "/permisos/" + idArea,
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
        ...
        var table = $('#empleados-table').DataTable({
            ...
            columns: [
                ...
                { data: 'NArea', name: 'NArea' },
                {
                    ...
                    name: 'Permisos',
                    render: function (data, type, row) {
                        return `<a href="#${row.Id_Area}" class="btn btn-xs btn-info">Permisos ... <i class="fas fa-user-tag"></i></a>`;
                    }
                },
                {
                    data: null,
