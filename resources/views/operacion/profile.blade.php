...
@section('content_header')
    <h1><i class="fas fa-user-circle mr-2"></i> Perfil de Usuario (Operador)</h1>
@stop
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="card card-urvina-sync card-widget widget-user shadow-lg">
            ...
            <div class="widget-user-header text-white" style="background: linear-gradient(90deg, #0ea5a5, #0ea56a); height: auto; min-height: 135px; padding-bottom: 60px;">
                ...
                <h5 class="widget-user-desc text-light" style="font-weight: 300;">{{ $user->Txt_Puesto ?? 'Operador' }}</h5>
            </div>
                ...
                <div class="row mt-4"> 
                    ...
                    <div class="col-sm-6">
                        <div class="description-block">
                            ...
                            <span class="description-text">PLANTAS</span>
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
    ...
    <div class="col-md-8">
        ...
        <div class="card shadow-lg mb-4">
            ...
            <form action="{{ route('op.profile.update', ['language' => app()->getLocale()]) }}" method="POST">
                @csrf
                <div class="card-body">
        ...
        <div class="card shadow-lg">
            ...
            <form action="{{ route('op.profile.password', ['language' => app()->getLocale()]) }}" method="POST">
                @csrf
                <div class="card-body">
